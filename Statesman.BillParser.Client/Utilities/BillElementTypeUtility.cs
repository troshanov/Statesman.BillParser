...
{
    public static Dictionary<BillElementType, List<BillElementType>> RootDropDownAllowedTypes => new Dictionary<BillElementType, List<BillElementType>>
    {
    ...
    public static Dictionary<BillElementType, List<BillElementType>> ChildDropDownAllowedTypes => new Dictionary<BillElementType, List<BillElementType>>
    {
        { BillElementType.Chapter, new List<BillElementType> { BillElementType.Section, BillElementType.Article, BillElementType.Paragraph, BillElementType.Point, BillElementType.Letter } },
        { BillElementType.Section, new List<BillElementType> { BillElementType.Article, BillElementType.Paragraph, BillElementType.Point, BillElementType.Letter } },
        { BillElementType.Article, new List<BillElementType> { BillElementType.Paragraph, BillElementType.Point, BillElementType.Letter } },
        { BillElementType.Paragraph, new List<BillElementType> { BillElementType.Point, BillElementType.Letter } },
        { BillElementType.Point, new List<BillElementType> { BillElementType.Letter } },
    };
